          ...
          <table className="w-full text-sm">
            <thead className="bg-amber-50 border-b border-amber-100">
              <tr>
                <th
                  scope="col"
                  className="px-4 py-3 text-left text-amber-800 font-semibold"
                >
                  #
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="px-4 py-3 text-left text-amber-800 font-semibold max-sm:hidden"
                >
                  Date
                </th>
                <th
            ...
            <tbody className="divide-y divide-amber-100">
              ...
              dashboardData.recentBlogs.length > 0 ? (
                ...
                <tr>
                  <td
                    colSpan="5"
                    className="px-4 py-8 text-center text-amber-600"
                  >
