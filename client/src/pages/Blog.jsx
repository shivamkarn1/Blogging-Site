    ...
    <div className="relative min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-rose-50">
      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        <img
          ...
          alt=""
          className="rounded-3xl mb-5 shadow-lg border border-amber-200"
        />
        <div
          className="rich-text max-w-3xl mx-auto text-amber-800"
        ...
        <div className="bg-white rounded-2xl border border-amber-100 shadow-sm overflow-hidden">
          {Array.isArray(comments) && comments.length > 0 ? (
            comments.map((item, index) => (
              <div
                key={index}
                className={`p-4 hover:bg-amber-25 transition-colors ${
